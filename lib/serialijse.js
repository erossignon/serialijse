(function (exports) {
    ...
    function deserializeObject(context, object_id, object_definition) {
        ...
        if (classInfo.constructor.length === 0) {
            object = new classInfo.constructor();
        } else {
            object = {};
    ...
    function find_object(context, obj) {
        if (obj.____index !== undefined && context.objects[obj.____index] === obj) {
    ...
    function _serialize(context, object, options) {
        ...
        switch (typeof object) {
            ...
            case 'string':
                ...
                return object;
            case 'function' :
                return "function removed by serialijse serializing process";
            case 'object':
