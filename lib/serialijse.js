(function (exports) {
    ...
    function _serialize_xxx(context, object, options, construct, serialize) {
    ...
    function _serialize_map(context, object, options) {
        return _serialize_xxx(context, object, options,
            () => [],
            (context, object, mapJson, options) => {
                for (const [key, value] of object.entries()) {
                    mapJson.push([
                        _serialize(context, key, options),
                        _serialize(context, value, options),
                    ])
                }
            });
    }
    ...
    function _serialize_set(context, object, options) {
        return _serialize_xxx(context, object, options,
            () => [],
            (context, object, setJson, options) => {
                for (const value of object.values()) {
                    setJson.push(_serialize(context, value, options))
                }
            });
    }
    ...
    function _serialize_basic_object(context, object, options) {
    ...
    function _serialize_object(context, serializingObject, object, options) {
        ...
        if (className === "Array") {
            ...
            serializingObject.m = _serialize_map(context, object, options);
        } else if (object.constructor === Set) {
            serializingObject.s = _serialize_set(context, object, options);
        } else if (className === "Date") {
            serializingObject.d = object.getTime();
        } else {
            serializingObject.o = _serialize_basic_object(context, object, options);
        }
    }
